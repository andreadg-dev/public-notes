...
If you cannot find the `adobekey.py` script in the github repo mentioned above anymore, there you go:
...
# DEPENDENCIES: python -m pip install -U pycryptodome
